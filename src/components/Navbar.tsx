            ...
            {user ? (
              ...
              showAuthButtons && !isAuthPage && (
                <div className="flex items-center space-x-2">
                  <Link
                    to="/login"
                    className="flex items-center space-x-2 px-4 py-2.5 text-text-primary hover:text-primary-600 hover:bg-background-secondary rounded-xl transition-all duration-200 font-medium"
                  >
                    <LogIn size={18} />
            ...
            {isAuthPage && !user && (
              <div className="flex items-center space-x-2">
                {location.pathname !== '/login' && (
                  <Link
                    to="/login"
                    className="px-4 py-2.5 text-primary-600 hover:text-primary-700 font-medium transition-colors duration-200"
                  >
                    Sign In
                  </Link>
                )}
